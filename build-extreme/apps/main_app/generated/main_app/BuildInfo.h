...
namespace main_app_info {

constexpr std::string_view project_name = "CppCmakeProjectTemplate";
constexpr std::string_view project_version = "1.0.6";
...
constexpr std::string_view build_timestamp = "2026-03-31 16:56:12 UTC";
constexpr std::string_view cmake_version = "3.28.3";
constexpr std::string_view library_type = "Executable"; // Static or Shared

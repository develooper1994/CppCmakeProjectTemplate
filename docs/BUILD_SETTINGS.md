...
| `CMAKE_CXX_STANDARD` | _auto_  | Auto-detected; highest standard the compiler supports (up to C++23). Override: `-DCMAKE_CXX_STANDARD=20` |
...
| `CMAKE_CUDA_STANDARD`      | _auto_   | Device-code C++ std (derived from CUDA toolkit version)    |
...
| `CACHE_PROGRAM`   | _(auto)_             | Override compiler cache program path                    |
